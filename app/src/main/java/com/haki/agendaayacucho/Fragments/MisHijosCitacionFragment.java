 ...
 * {@link MisHijosCitacionFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MisHijosCitacionFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MisHijosCitacionFragment extends Fragment {
    ...
    public MisHijosCitacionFragment() {
     ...
     * @return A new instance of fragment MisHijosCitacionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MisHijosCitacionFragment newInstance(String param1, String param2) {
        MisHijosCitacionFragment fragment = new MisHijosCitacionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mis_hijos_citacion, container, false);
        listaEstudiante = new ArrayList<>();
        maya = new Maya(getContext());

        rvMisHijos = view.findViewById(R.id.mh_rvHijosCitacion);
        consultarHijos();
